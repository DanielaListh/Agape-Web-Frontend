//script para previsualizar las imagenes que se desean subir a traves de los 
// formularios del crud, put caracteristicas
...
document.getElementById('imagenUrl').addEventListener('change', function(event){ 
    ...
    const img = document.getElementById('imagenCaractClinica');
